...
[macro](https://docs.ropensci.org/tic/reference/macro.md)s combine
several steps and assign them to relevant stages. See
[`dsl_get()`](https://docs.ropensci.org/tic/reference/dsl_get.md) for
functions to access the storage for the stages and their steps.
...
- step:
  ...
  `[function]`  
  An object of class
  [TicStep](https://docs.ropensci.org/tic/reference/TicStep.md), usually
  created by functions with the `step_` prefix like
  [`step_hello_world()`](https://docs.ropensci.org/tic/reference/step_hello_world.md).
