...
The [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md)
function prepares a code repository for use with this package. See
[DSL](https://docs.ropensci.org/tic/reference/dsl.md) for an overview of
tic's domain-specific language for defining stages and steps,
[`step_hello_world()`](https://docs.ropensci.org/tic/reference/step_hello_world.md)
and the links therein for available steps, and
[macro](https://docs.ropensci.org/tic/reference/macro.md) for an
