...
1.  [`step_setup_ssh()`](https://docs.ropensci.org/tic/reference/step_setup_ssh.md)
    in the `"before_deploy"` to setup the upcoming deployment

2.  [`step_setup_push_deploy()`](https://docs.ropensci.org/tic/reference/step_setup_push_deploy.md)
    in the `"before_deploy"` stage (if `deploy` is set),

3.  [`step_add_to_drat()`](https://docs.ropensci.org/tic/reference/step_add_to_drat.md)
    in the `"deploy"`

4.  [`step_do_push_deploy()`](https://docs.ropensci.org/tic/reference/step_do_push_deploy.md)
    in the `"deploy"` stage.
