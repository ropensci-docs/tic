...
by [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md).
...
[`add_step()`](https://docs.ropensci.org/tic/reference/dsl.md), or
macros like
...
[`vignette("build-lifecycle", package = "tic")`](https://docs.ropensci.org/tic/articles/build-lifecycle.md)
for more details.
...
[`get_stage()`](https://docs.ropensci.org/tic/reference/dsl.md) and
[`add_step()`](https://docs.ropensci.org/tic/reference/dsl.md) functions
to configure, and the
[stages](https://docs.ropensci.org/tic/reference/stages.md) functions to
run.

## Details

Stages and steps defined using tic's
[DSL](https://docs.ropensci.org/tic/reference/dsl.md) are stored in an
internal object in the package. The stages are accessible through
`dsl_get()`. When running the
[stages](https://docs.ropensci.org/tic/reference/stages.md), by default
a configuration defined in the `tic.R` file is loaded with `dsl_load()`.
See [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md)
