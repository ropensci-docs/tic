...
- For testing purposes, all stages and steps defined in `tic.R` can be
  ...
  Running tic
  locally](https://docs.ropensci.org/tic/articles/advanced#troubleshooting-running-tic-locally)
...
for stage “deploy”
[`tic::deploy()`](https://docs.ropensci.org/tic/reference/stages.md).
...
deployment](https://docs.ropensci.org/tic/articles/deployment.md) for
more information.
...
[`add_step()`](https://docs.ropensci.org/tic/reference/dsl.md) function
to chain steps in `tic.R`, for example
...
[`add_step()`](https://docs.ropensci.org/tic/reference/dsl.md) and the
...
| Step | Description |
|----|----|
| [`step_hello_world()`](https://docs.ropensci.org/tic/reference/step_hello_world.md) | Print “Hello, World!” to the console, helps testing a tic setup |
| [`step_write_text_file()`](https://docs.ropensci.org/tic/reference/step_write_text_file.md) | Creates a text file with arbitrary contents |

#### Installation

| Step | Description |
|----|----|
| [`step_install_cran()`](https://docs.ropensci.org/tic/reference/step_install_pkg.md) | Installs one package from CRAN via [`install.packages()`](https://rdrr.io/r/utils/install.packages.html) if it is not yet installed. |
| [`step_install_github()`](https://docs.ropensci.org/tic/reference/step_install_pkg.md) | Installs one or more packages from GitHub via [`remotes::install_github()`](https://remotes.r-lib.org/reference/install_github.html) |

#### R package specific

| Step | Description |
|----|----|
| [`step_build_pkgdown()`](https://docs.ropensci.org/tic/reference/step_build_pkgdown.md) | Building package documentation via [pkgdown](https://github.com/r-lib/pkgdown) |
| [`step_rcmdcheck()`](https://docs.ropensci.org/tic/reference/step_rcmdcheck.md) | Run `R CMD check` via the {rcmdcheck} package |

#### Deployment

| Step | Description |
|----|----|
| `step_install_ssh_key()` | Make available a private SSH key (which has been added before to your project by [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md) or [`tic::use_ghactions_deploy()`](https://docs.ropensci.org/tic/reference/use_ghactions_deploy.md)). |
| [`step_test_ssh()`](https://docs.ropensci.org/tic/reference/step_test_ssh.md) | Test the SSH connection to GitHub, helps troubleshooting deploy problems. |
| [`step_setup_ssh()`](https://docs.ropensci.org/tic/reference/step_setup_ssh.md) | Adds to known hosts, installs private key, and tests the connection. |
| [`step_setup_push_deploy()`](https://docs.ropensci.org/tic/reference/step_setup_push_deploy.md) | Clones a repo, initiates author information, and sets up remotes for a subsequent [`step_do_push_deploy()`](https://docs.ropensci.org/tic/reference/step_do_push_deploy.md). |
| [`step_do_push_deploy()`](https://docs.ropensci.org/tic/reference/step_do_push_deploy.md) | Deploy to GitHub. |
| [`step_push_deploy()`](https://docs.ropensci.org/tic/reference/step_push_deploy.md) | Combines [`step_setup_push_deploy()`](https://docs.ropensci.org/tic/reference/step_setup_push_deploy.md) and [`step_do_push_deploy()`](https://docs.ropensci.org/tic/reference/step_do_push_deploy.md). |
