...
streamlined preparation process is run, utilizing the [R Client
...
[Deployment](https://docs.ropensci.org/tic/articles/deployment.md)
vignette.
...
[`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md). See
the [Example
projects](https://docs.ropensci.org/tic/articles/tic.html#example-projects)
...
lifecyle](https://docs.ropensci.org/tic/articles/build-lifecycle.md)
vignette.

## Easier troubleshooting

{tic} comes with the ability to [emulate a CI run
locally](https://docs.ropensci.org/tic/articles/advanced.html#emulate-a-ci-run-locally)
and [debug problems in the config
file](https://docs.ropensci.org/tic/articles/advanced#troubleshooting-running-tic-locally)
by calling
