...
- [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md): use
  GitHub Actions as the default provider for all platforms
...
- New function
  [`tic::use_ghactions_deploy()`](https://docs.ropensci.org/tic/reference/use_ghactions_deploy.md)
...
- [`ci_can_push()`](https://docs.ropensci.org/tic/reference/ci.md) never
  fails.
...
- `ci_can_Push()`: Error with descriptive error message if deployment is
  not possible
- [`ci_can_push()`](https://docs.ropensci.org/tic/reference/ci.md): Fix
  for Travis CI
...
- [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md): add
  key_name_private and key_name_public args from
...
- All files created by
  [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md) are
...
- [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md) now
  uses boxes from {cli} for better structured output
...
- New [`dsl_get()`](https://docs.ropensci.org/tic/reference/dsl_get.md)
  and
  [`dsl_init()`](https://docs.ropensci.org/tic/reference/dsl_get.md).
- Added examples to help for
  [`get_stage()`](https://docs.ropensci.org/tic/reference/dsl.md) and
  macros ([\#77](https://github.com/ropensci/tic/issues/77)).
...
- New [`use_tic()`](https://docs.ropensci.org/tic/reference/use_tic.md),
  moved from {travis}
...
- [`do_pkgdown()`](https://docs.ropensci.org/tic/reference/do_pkgdown.md)
  ...
  pages. The new
  [`?macro`](https://docs.ropensci.org/tic/reference/macro.md) help page
...
- [`add_step()`](https://docs.ropensci.org/tic/reference/dsl.md) now
...
- New [`ci_get_env()`](https://docs.ropensci.org/tic/reference/ci.md),
  [`ci_has_env()`](https://docs.ropensci.org/tic/reference/ci.md) and
...
- New [`tic()`](https://docs.ropensci.org/tic/reference/tic-package.md)
...
- Fix
  ...
  and [`deploy()`](https://docs.ropensci.org/tic/reference/stages.md).
...
- Use new DSL with the notion of stages with arbitrary names.
  ...
  - [`ci()`](https://docs.ropensci.org/tic/reference/ci.md) is now
    exported
